...
Source: the local version 07 Blender campus. There are 31 map-code records, 14
buildings with developed details, 14 initial street-facade studies, a provisionally attributed 61A facade, and one unresolved footprint. Most dimensions
...
Existing version 07 model, building catalogue, OSM footprint provenance and native
Blender renders. The overview uses simplified materials. Twenty-nine on-demand
...
geometry. 49L and 35L remain outside the modeled street-study set. 61A now has a developed
