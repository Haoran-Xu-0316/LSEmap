...
Source: the local version 06 Blender campus. There are 31 map-code records, 14
buildings with developed details, 14 initial street-facade studies, and one unresolved footprint. Most dimensions
...
Existing version 06 model, building catalogue, OSM footprint provenance and native
Blender renders. The overview uses simplified materials. Twenty-eight on-demand
...
geometry. Three special records remain outside the modeled street-study set.
