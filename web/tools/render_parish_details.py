"""Render original version-10 Parish Hall study for public gallery thumbnails.
...
OUT = ROOT / 'result/blender/stage10/parish/renders'
OUT.mkdir(parents=True, exist_ok=True)
bpy.ops.wm.open_mainfile(filepath=str(ROOT / 'result/blender/LSE_campus_detailed_v10.blend'))
# Earlier galleries remain unchanged; render the locally refined Parish Hall elevation.
records = json.loads((ROOT / 'result/blender/stage10/parish/parish-manifest.json').read_text())['buildings']
