"""Render original version-12 Lincoln Chambers study for public gallery thumbnails.
...
OUT = ROOT / 'result/blender/stage12/lincoln/renders'
OUT.mkdir(parents=True, exist_ok=True)
bpy.ops.wm.open_mainfile(filepath=str(ROOT / 'result/blender/LSE_campus_detailed_v12.blend'))
# Earlier galleries remain unchanged; render the locally refined Lincoln Chambers elevation.
records = json.loads((ROOT / 'result/blender/stage12/lincoln/lincoln-manifest.json').read_text())['buildings']
