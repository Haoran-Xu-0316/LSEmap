"""Render original version-11 St Clement's study for public gallery thumbnails.
...
OUT = ROOT / 'result/blender/stage11/stc/renders'
OUT.mkdir(parents=True, exist_ok=True)
bpy.ops.wm.open_mainfile(filepath=str(ROOT / 'result/blender/LSE_campus_detailed_v11.blend'))
# Earlier galleries remain unchanged; render the locally refined St Clement's elevation.
records = json.loads((ROOT / 'result/blender/stage11/stc/stc-manifest.json').read_text())['buildings']
